declare function createStore<N extends string, I extends string, O extends string>(config: ORS.CreateStoreConfig<N, I, O>): {
    ...
    mutate: (payload: ORS.StoreObject<N, I> | ORS.StoreObject<N, I>[]) => void;
    mutateWhere: <N_3 extends string, O_3 extends Record<string, any>>(options: ORS.SelectOptions<N_3, O_3>, callback: (current: Partial<O_3> | null) => Partial<O_3> | null) => void;
